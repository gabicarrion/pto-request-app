...
/**
 * Admin Page component for managing teams and users
 * 
 * @param {Object} props
 * @param {Object} props.currentUser - Current user information
 * @param {boolean} props.isAdmin - Whether current user is an admin
 * @param {Function} props.showNotification - Function to show notifications
 */
function AdminPage({ currentUser, isAdmin, showNotification }) {
                    ...
                    {teams.map(team => {
                      ...
                      const teamMembers = users.filter(user => {
                        if (user.team_memberships && Array.isArray(user.team_memberships)) {
                          return user.team_memberships.some(membership => membership.team_id === team.id);
                        }
                          ...
                          <td>
                            <button 
                              ...
                              onClick={() => {
                                ...
                                // You would pass the selected team to the modal here
                              }}
                            >
                              Manage
                            </button>
                        ...
                        <tr key={user.id}>
                          ...
                          <td>
                            <button 
                              ...
                              onClick={() => {
                                setShowTeamModal(true);
                                // You would pass the selected user to the modal here
                              }}
                            >
                              Edit
                            </button>
